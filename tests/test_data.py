                ...
                for img_file in image_files[:5]:  # Test first 5 images
                    try:
                        with Image.open(img_file) as img:
                            ...
                            assert img.mode in ['RGB', 'RGBA', 'L'], f"Image {img_file} has unsupported mode: {img.mode}"
        ...
        for class_dir in class_dirs:
            ...
            if path.exists():
                ...
                for img_file in image_files:
                    ...
                    assert img_file.suffix.lower() in ['.jpg', '.jpeg', '.png'], f"Invalid extension: {img_file.suffix}"
        ...
        for class_dir in class_dirs:
            ...
            if path.exists():
                ...
                for img_file in image_files:
                    ...
                    assert file_size < 50 * 1024 * 1024, f"Image file too large: {file_size} bytes"
